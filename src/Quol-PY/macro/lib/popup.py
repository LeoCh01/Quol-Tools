...
class Popup:
    def __init__(self, text):
        ...
        self.top = PopupSub('', QRect(0, -30, screen_w, 50), 30, [0, -1])
        self.bottom = PopupSub(text, QRect(0, screen_h - 20, screen_w, 50), 30, [0, 1])
        self.left = PopupSub('', QRect(-30, 0, 50, screen_h), 30, [-1, 0])
        self.right = PopupSub('', QRect(screen_w - 20, 0, 50, screen_h), 30, [1, 0])
